...
//        URI requiredUrl = exchange.getRequiredAttribute(ServerWebExchangeUtils.GATEWAY_REQUEST_URL_ATTR);
//        String scheme = requiredUrl.getScheme();
//        if (!"ws".equals(scheme) && !"wss".equals(scheme)) {
//            return chain.filter(exchange);
//        }
//        String wsScheme = this.convertWsToHttp(scheme);
//        URI wsRequestUrl = UriComponentsBuilder.fromUri(requiredUrl).scheme(wsScheme).build().toUri();
